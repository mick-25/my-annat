...
JACKETT_URL: str = os.environ.get("JACKETT_URL", "http://37.187.141.48:9117")
JACKETT_API_KEY: str = os.environ.get("JACKETT_API_KEY", "10f9a9qd7wtq1lxutduyxz33zprl2gri")
...
JACKETT_INDEXERS_LIST: list[str] = os.environ.get(
    "JACKETT_INDEXERS",
    "cpasbienclone,torrent9,torrent9clone,yggtorrent",
).split(",")
