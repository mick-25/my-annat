...
JACKETT_INDEXERS_LIST: list[str] = os.environ.get(
    "JACKETT_INDEXERS",
    "btsow,hdsky,fearnopeer,filelist,milkie,ncore,onlyencodes-api,privatehd,scenehd,skipthecommercials-api,teamhd,thesceneplace,torlock,torrentproject2,xspeeds",
).split(",")
